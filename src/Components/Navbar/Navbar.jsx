...
const Navbar = ()=>{
  return <nav className ={c.nav}>
      <div className={`${c.item} ${c.active}`}><NavLink to="/content" activeClassName={c.activeLink}>Profile</NavLink></div>
      <div className={c.item}><NavLink to="/dialogs" activeClassName={c.activeLink}>Massege</NavLink></div>
